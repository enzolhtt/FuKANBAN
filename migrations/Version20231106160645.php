 ...
 */
final class Version20231106160645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE taches (id INT AUTO_INCREMENT NOT NULL, libelle_statut_id INT DEFAULT NULL, nom_projet_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, titre_tache VARCHAR(255) NOT NULL, description_tache VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_echeance DATETIME NOT NULL, INDEX IDX_3BF2CD98E94AD1B4 (libelle_statut_id), INDEX IDX_3BF2CD989430F333 (nom_projet_id), INDEX IDX_3BF2CD98FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
